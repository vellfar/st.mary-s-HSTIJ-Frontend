...
export default function ShopPageComponent({ products }: ShopPageComponentProps) {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      ...
      const categoryTitles = [
        ...Array.from(new Set((products as { category: string }[]).map(product => product.category))),
      ];
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold mb-8 text-gray-900">OUR TECH SHOP💻</h1>
                ...
                {currentProducts.map((product) => (
                  ...
                  >
                    <Card className="overflow-hidden cursor-pointer transition-transform duration-200 hover:scale-105">
                      ...
                      <CardContent>
                        <p className="font-bold text-2xl mb-2">${product.price}</p>
